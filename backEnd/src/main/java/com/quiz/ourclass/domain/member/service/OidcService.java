...
public class OidcService {
    ...
    * */
    ...
    public OIDCDecodePayload certificatingIdToken (String idToken) throws Exception {
        ...
        OIDCPublicKeyDTO nowKey = keys.getKeys().stream().filter(key -> key.getKid().equals(kid)).findFirst().orElseThrow(Exception::new);


        System.out.println(nowKey.getKid());
        System.out.println(kid);
        System.out.println(oicdUtil.getOIDCTokenBody(idToken, nowKey.getN(), nowKey.getE()).toString());
